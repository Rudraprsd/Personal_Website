...
const Data = () => {
    return (
        <div className="home__data">
            ...
            <h3 className="home__subtitle">Scientist</h3>
            <p className="home__description">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Pariatur, asperiores voluptatibus magnam quam amet itaque.</p>
